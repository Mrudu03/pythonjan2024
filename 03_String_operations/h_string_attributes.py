...
print("default11: ", "1 2 3".split())  # ['1', '2', '3']
print("default12:", "   1   2  3   ".split())  # ['1', '2', '3']
print("default13: ", "   1   2  3   ".split(" "))  # ['', '', '', '1', '', '', '2', '', '3', '', '','']



print("rsplit11", "1,2,3,4,5".rsplit(None, 1))  # ['1,2,3,4,5']
print()
...
result1 = "aaaaaaaaaaa".replace("a", "b")
print(result1)  # Output: 'bbbbbbbbbbb'

result2 = "aaaaaaaaaaa".replace("a", "b", 2)
print(result2)  # Output: 'bbaaaaaaaaa'

reverse_result2 = result2[::-1]
