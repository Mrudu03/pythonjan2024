...
input_string = "today is good day"
str1 = input_string[:5]
str2 = input_string[6:8]
str3 = input_string[9:13]
str4 = input_string[14:]
print("input : ", str1 + " " + str2 + " " + str3 + " " + str4)

#reverse of the input string
print("output : ", str1[::-1] + " " + str2[::-1] + " " + str3[::-1] + " " + str4[::-1])
