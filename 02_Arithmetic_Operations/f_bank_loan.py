...
compound_payable = borrowed_amount * (1 + rate_of_interest)**loan_duration
compound_intrest_amount = compound_payable - borrowed_amount

print("Compound Interest amount    :", compound_intrest_amount)
print("total amount to pay(compound):", compound_payable)